const resumeLines = [
  ...
  { text: "Java, Python, C++, JavaScript, SQL, React, Tailwind CSS, Node.js, Express.js,", size: 10, y: 627 },
  { text: "Spring Boot, MySQL, MongoDB, Machine Learning, OpenCV, Scikit-Learn, Git", size: 10, y: 613 },
  ...
  { text: "Movie Ticket Booking System - Java Swing, MySQL, live seats, payment workflow.", size: 10, y: 551 },
  { text: "Resume Builder - Dynamic creation, live preview, and download functionality.", size: 10, y: 535 },
  { text: "GitHub Repository Backup Tool - Python CLI, GitHub API, JSON export, authentication.", size: 10, y: 519 },
